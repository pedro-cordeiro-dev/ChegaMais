...
import {View, Text, TextInput, Image, TouchableOpacity, ScrollView, StatusBar, FlatList,} from 'react-native';
...
const ItemCategoria = ({ nome, icone, isSelected }) => (
...
export default function TelaHome() {
  ...
  <View style={stylesHome.headerTop}>
    <View style={stylesHome.perfilContainer}>
      <View>
        ...
        <Text style={stylesHome.userName}>ISABELA SILVA</Text>
      </View>
    </View>
  ...
  <FlatList
    data={CATEGORIAS}
    renderItem={({ item }) => (
      <ItemCategoria nome={item.nome} icone={item.icone} isSelected={item.nome === 'Outros'} />
    )}
