...
const DADOS_POR_CATEGORIA = {
  '1': [
    { id: 'l1', nome: 'PARQUE DA CIDADE', local: 'Rua Fictícia, 100', imagem: 'https://www.temporadalivre.com/uploads/editor/pictures/1328/parque_da_cidade_temporadalivre.jpg' },
    { id: 'l2', nome: 'CINEMA', local: 'Shopping Central', imagem: 'https://www.shoppingcidade.com.br/wp-content/uploads/2023/08/fachada-cineart-shopping-cidade-1.png' },
  ],
  '2': [
    { id: 'c1', nome: 'RESTAURANTE', local: 'Av. Gastronômica, 50', imagem: 'https://media.timeout.com/images/105904487/750/422/image.jpg' },
    { id: 'c2', nome: 'HAMBURGUERIA', local: 'Praça Principal', imagem: 'https://classic.exame.com/wp-content/uploads/2023/03/franquia-hamburgueria.jpg?quality=70&strip=info&w=1024' },
  ],
  '3': [
    { id: 'e1', nome: 'GINÁSIO', local: 'Complexo Esportivo', imagem: 'https://prefeitura.pbh.gov.br/sites/default/files/styles/slideshow/public/estrutura-de-governo/esportes-e-lazer/2022/Julho/ginasio%20olimpico%203.JPG?itok=8E2T70oJ' },
  ],
  '4': [
    { id: 's1', nome: 'SHOPPING', local: 'Av. das Compras', imagem: 'https://www.assai.com.br/sites/default/files/styles/blog_detalhe/public/blog/shopping_center_entenda_o_que_e_e_como_funciona_1.jpg?itok=f4qS_sOK' },
  ],
};
...
export default function TelaHome({ navigation }) {
  ...
  const dadosFiltrados = DADOS_POR_CATEGORIA[categoriaSelecionada] || [];
